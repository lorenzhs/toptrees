...
plot \
    ...
    'edges-data.txt' index 6 title "file=xml/enwiki-latest-pages-articles12.xml" with linespoints, \
    'edges-data.txt' index 7 title "file=xml/factor12.xml" with linespoints, \
    'edges-data.txt' index 8 title "file=xml/factor2.xml" with linespoints, \
    'edges-data.txt' index 9 title "file=xml/factor4.8.xml" with linespoints, \
    'edges-data.txt' index 10 title "file=xml/factor4.xml" with linespoints, \
    'edges-data.txt' index 11 title "file=xml/factor7.xml" with linespoints, \
    'edges-data.txt' index 12 title "file=xml/nasa.xml" with linespoints, \
    'edges-data.txt' index 13 title "file=xml/proteins.xml" with linespoints, \
    'edges-data.txt' index 14 title "file=xml/treebank_e.xml" with linespoints, \
    'edges-data.txt' index 15 title "file=xml/uwm.xml" with linespoints, \
    'edges-data.txt' index 16 title "file=xml/wiki.xml" with linespoints
